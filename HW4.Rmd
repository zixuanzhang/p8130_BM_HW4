...
Interpretation: The fitted model indicates that for every unit increase in ER visits, the mean total cost in dollars on logarithm scale will increase by 0.23. when the ER visit is zero, the mean total cost in dollar on logarithm scale will be 5.517. The p value for two estimators $\beta_{0}$ and $\beta_{1}$ are well below 0.001. So we are very confident that there is a strong association between total cost and ER visits, and our simple regression model describes their relationship.
