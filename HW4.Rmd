...
While holding age and anxiety level constant, the mean __decrease__ of satisfaction score with an unit increase in severity of illness is 0.442. We are 95% confident that the mean change of satisfaction score with one unit increase in severity of illness is between -1.43 to 0.551.
...
new_data <- tibble(Age = 35,
                   Severity = 42,
                   Anxiety = 2.1)
predict.lm(MLR_all, new_data, interval="confidence", conf.level = 0.95)
```

Comment: The point estimator for this new patient's satisfaction score is 71.7. We are 95% confident that the predicted satisfaction score for this new patient will be between 64.2 to 79.1
